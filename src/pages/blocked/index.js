...
import Phishing from "../../../public/icons/phishing.png";
...
function Blocked() {
    ...
    return (
        <div>
            <Head>
                <title>BlockBait has blocked this website</title>
                ...
                <div className='w-[90vw] mx-auto mt-[5%]'>
                    <div className="grid grid-cols-1 md:grid-cols-2 items-start gap-10">
                        <div className='flex flex-col space-y-6 items-start justify-start'>
                            ...
                            <h2 className='text-[2.5rem] text-black/90'>Access to this website has been restricted due to its classification as a &rsquo;phishing&lsquo; site</h2>
                            <p className='text-[1rem] text-black/70'>It is highly recommended that you avoid visiting this website as it has the potential to deceive you into sharing sensitive information like personal or financial details, thereby jeopardizing your identity and security.</p>
                            <div className='flex items-center space-x-8'>
                                <button className='px-6 py-3 rounded border-2 border-[#4E46B4]  text-[1rem] ' role='button' onClick={handleBackToSafety}> &larr; Back to safety</button>
                                <button className='px-6 py-3 rounded border-2  border-[#4E46B4] bg-[#4E46B4] text-[1rem] text-white' role='button' onClick={handleVisitWebsite}> Visit website</button>
                            </div>
                        </div>
                        {/* blocked image */}
                        <div className='w-[75%] mx-auto aspect-square' style={{
                            background: `url(${Phishing.src}) center center/contain no-repeat`,
                        }}></div>
                    </div>
                </div>
            </main>
